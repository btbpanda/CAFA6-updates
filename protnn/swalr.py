...
class SWALRWrapper:
    def __init__(self, model, optimizer, swa_start=5, swa_lr=0.05, anneal_epochs=15, anneal_strategy='cos'):
        """
        ...
        self.cosine_scheduler = CosineAnnealingLR(optimizer, T_max=anneal_epochs)
